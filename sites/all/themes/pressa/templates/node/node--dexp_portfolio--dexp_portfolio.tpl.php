    ...
    <div class="portfolio-item-inner">
      ...
      <div class="portfolio-item-overlay">
        ...
        <div class="portfolio-item-tools">
          <a href="<?php print $node_url; ?>" class="view-details"><span class="fa fa-external-link"></span></a>
          <a href="<?php print $first_image; ?>" data-toggle="tooltip" title="<?php print t('View Large')?>" rel="lightbox[<?php print $lightboxrel;?>]" class="zoom"><span class="fa fa-search"></span></a>
        </div>
		  <div class="portfolio-item-footer">
				<div class="portfolio-category"><i class="fa fa-folder-open"></i>
					<?php print strip_tags(render($content['field_portfolio_categories'])); ?>
				</div>
				<div class="portfolio-like"><i class="fa fa-heart"></i> 10 Likes</div>
		  </div>
      </div>
    </div>
  </div>
