...
*/
?>
<div id="node-<?php print $node->nid; ?>" class="post full <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="post-content">
    ...
    <div class="post-meta">
        ...
        <span><i class="fa fa-comments"></i><?php print $comment_count;?> Comment(s)</span>
    </div>
    <div class="post_desc">
