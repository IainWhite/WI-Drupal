            ...
            <div class="portfolio-overlay">
                <div class="portfolio-info">
                    <div class="portfolio-tools">
                        <a href="<?php print $node_url; ?>"><span class="fa fa-link"></span></a> <a href="<?php print $first_image; ?>" rel="prettyPhoto[<?php print $lightboxrel; ?>]"><span class="fa fa-search"></span></a>
                    </div>
